...
},{"./modules/form-validate/form":4,"./modules/tabs/init-tabs":10,"./price-shadow":12,"./sliders":13,"./utils/ios-vh-fix":15,"./video":16}],3:[function(require,module,exports){
"use strict";
...
var priceWrapperElements = document.querySelectorAll('.prices__card-price-wrapper');
function addPriceShadow() {
  priceWrapperElements.forEach(function (priceWrapperElement) {
    var elementTextContent = priceWrapperElement.querySelector('span').textContent;
    var shadowStyle;
    ...
    priceWrapperElement.insertAdjacentHTML('afterbegin', "<span style=\"".concat(shadowStyle, "\">").concat(elementTextContent, "</span>"));
  });
}
addPriceShadow();
...
var _swiper = _interopRequireDefault(require("./libs/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initCoachesSlider = function initCoachesSlider() {
  var coachesSlider = new _swiper.default('.coaches__slider', {
    slidesPerView: 4,
    spaceBetween: 40,
    loop: true,
    navigation: {
...
var initReviewsSlider = function initReviewsSlider() {
  var reviewsSlider = new _swiper.default('.reviews__wrapper', {
    // slidesPerView: 1,
    spaceBetween: 100,
    loop: false,
    navigation: {
...
},{"./libs/swiper":1}],14:[function(require,module,exports){
"use strict";
...
var videoPlayerElement = document.querySelector('.gym-room__video-player');
var videoPlaceholderElement = document.querySelector('.gym-room__video-placeholder');
